...
public class Pricechange extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        highproductprice.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                highproductpriceKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
    ...
    private void lowproductpriceKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lowproductpriceKeyPressed
        ManageValidation.validateNumber(lowproductprice, 7);
    }//GEN-LAST:event_lowproductpriceKeyPressed

    private void highproductpriceKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_highproductpriceKeyPressed
        ManageValidation.validateNumber(highproductprice, 7);
    }//GEN-LAST:event_highproductpriceKeyPressed
