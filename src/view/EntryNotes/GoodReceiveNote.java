...
public class GoodReceiveNote extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1140, 30));
        ...
        kGradientPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 790, 350));
        ...
        kGradientPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 590, 1140, 20));
        ...
        kGradientPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 50, 320, 150));
        ...
        jPanel4.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 50, 90, 20));
        ...
        jPanel4.add(F16BNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 130, 25));
        ...
        jPanel4.add(billNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 50, 80, 25));

        jLabel7.setText("ස්ථානය");
        jLabel7.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, 90, 20));
        ...
        jPanel4.add(storeCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 10, 40, 25));

        jLabel25.setText("සැපයැම්කරු");
        jLabel25.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jPanel4.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 110, 20));

        jLabel26.setText("ගෙවීම්");
        jLabel26.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jPanel4.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 50, 70, 20));
        ...
        jPanel4.add(storeName, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 10, 100, 25));

        payType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-select-", "Cheque", "PettyCash", "ApprovedBuy", "Stores" }));
        jPanel4.add(payType, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 50, 100, 25));

        jLabel28.setText("F16B අංකය");
        jLabel28.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jPanel4.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 90, 20));

        dsfsd.setText("දිනය");
        dsfsd.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jPanel4.add(dsfsd, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 70, 40));
        ...
        jPanel4.add(supplierName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 50, 100, 25));
        ...
        jPanel4.add(supplierCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 50, 50, 25));
        ...
        jLabel29.setText("F23 අංකය");
        jPanel4.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 90, 20));

        F23No.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                F23NoActionPerformed(evt);
            }
        });
        jPanel4.add(F23No, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 120, 25));

        kGradientPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 790, 90));
        ...
        kGradientPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 210, 320, 370));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(kGradientPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 1142, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            if(r==1){
                ...
                for(int i=0; i < RowCount; i++){
                    ...
                    if(re1==1){
                        ...
                        if(name == "Save"){
                            ...
                            ResultSet re = item.getItemStock(Integer.valueOf(dtm.getValueAt(i, 1).toString()));
                            while(re.next()){
                                sQty = re.getDouble("stockQty");
                                mQty = re.getDouble("maxQty");
                            }
                            sQty = sQty + Double.valueOf(dtm.getValueAt(i, 6).toString());
                            
                            int t = item.UpdateItemStock(Integer.valueOf(dtm.getValueAt(i, 1).toString()), sQty);
                            if(t==1){
                                ++r1;
                            }else{
                                JOptionPane.showMessageDialog(null, "Error in updating item stock of item no " + dtm.getValueAt(i, 1).toString(), "SuperMarket Management", JOptionPane.ERROR_MESSAGE);
                            }
                        }                   
                    }else{
                ...
                if (r1 != RowCount) {
                    ...
                    for(int j=0; j< RowCount1; j++){
                        ...
                        if(re2 ==1){
                            if(name == "Save"){
                            System.out.println("hi btn "+ name);
                            double sQty=0, mQty=0;
                            ManageItem item  = new ManageItem();
                            ResultSet re = item.getItemStock(Integer.valueOf(dtm.getValueAt(j, 1).toString()));
                            while(re.next()){
                            System.out.println(re.getDouble("stockQty"));
                                sQty = re.getDouble("stockQty");
                                mQty = re.getDouble("maxQty");
                                
                                System.out.println(sQty);
                            }
                            sQty = sQty + Double.valueOf(dtm.getValueAt(j, 4).toString());
//                            System.out.println(sQty);
//                            if(sQty < mQty){
                                ...
                                if(t==1){
                                    ...
                                    JOptionPane.showMessageDialog(null, "Error in updating item stock of item no " + dtm.getValueAt(j, 1).toString(), "SuperMarket Management", JOptionPane.ERROR_MESSAGE);
                                }
//                            }
                        }  
                        }else{
                    ...
                    if(r1==1){
                        ...
                        if(r2==1){
                            ...
                            if(r3==1){
                                ...
                                if(r4==1){
                                    grn.grn(F16BNo.getText(), java.sql.Date.valueOf(date.getDate()), "save", F23No.getSelectedItem().toString());
                                    manageGrn= new ManageGoodReceiveNote(grn);
                                    saveRecords("Save");
...
//                              JOptionPane.showMessageDialog(null, "GRN saved Permenantly", "SuperMarket Management", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    grn.grn(F16BNo.getText(), java.sql.Date.valueOf(date.getDate()), "notSaved", F23No.getSelectedItem().toString());
                    manageGrn= new ManageGoodReceiveNote(grn);
    ...
    private void jTable4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MousePressed
        try{
            ...
            while(result1.next()){
                ...
                F23No.setSelectedItem(result1.getString("F23No"));
            }
