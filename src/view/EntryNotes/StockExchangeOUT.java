                        ...
                        for(int n=0; n< RowCount1; n++){
                            ...
                            if(k ==1){
                                ...
                                if(t==1){
                                    ...
                                    JOptionPane.showMessageDialog(null, "Error in updating Stock Exchange out item no " + dtm.getValueAt(n, 1).toString(), "SuperMarket Management", JOptionPane.ERROR_MESSAGE);
                                }
                            }
                        }
                        if(r2 == RowCount1){
