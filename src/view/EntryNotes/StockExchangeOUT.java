...
import controller.ManageStockExhangeOUT;
...
public class StockExchangeOUT extends javax.swing.JDialog {
    
    stockExchangeOUT exchange = new stockExchangeOUT();
    ManageStockExhangeOUT manage = new ManageStockExhangeOUT(exchange);
    
    
    double bprice =0, sprice=0, bTotal =0, sTotal =0, iqty=0, subBprice=0, subSprice=0;
    
    StockExchangeOUT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            if(grn == ""){
                ...
                if(String.valueOf(nno).length() == 1){
                    grn = "DOO22KT00000" + String.valueOf(nno);
                }else if(String.valueOf(nno).length() == 2){
                    grn = "DOO22KT0000" + String.valueOf(nno);
                }else if(String.valueOf(nno).length() == 3){
                    grn = "DOO22KT000" + String.valueOf(nno);
                }else if(String.valueOf(nno).length() == 4){
                    grn = "DOO22KT00" + String.valueOf(nno);
                }else if(String.valueOf(nno).length() == 5){
                    grn = "DOO22KT0" + String.valueOf(nno);
                }else{
                    grn = "DOO22KT" + String.valueOf(nno);
                }
            }            
    ...
    private void initComponents() {
        ...
        jLabel1.setText("වෙනත්  ස්ථානයට යැවීම");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 190, 30));
        ...
        jPanel4.add(fromNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, 60, 25));
        ...
        jPanel4.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 70, 40));
        ...
        fromName.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-select-" }));
        fromName.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                fromNameItemStateChanged(evt);
            }
        });
        jPanel4.add(fromName, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 150, 25));

        toName.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-select-" }));
        toName.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                toNameItemStateChanged(evt);
            }
        });
        jPanel4.add(toName, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 150, 25));
        ...
        jPanel4.add(toNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 40, 60, 25));

        jLabel8.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jLabel8.setText("ස්ථානයට");
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 40, 90, 20));

        jLabel7.setFont(new java.awt.Font("Nirmala UI", 0, 15)); // NOI18N
        jLabel7.setText("ස්ථානයේ සිට");
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 100, 20));
        jPanel4.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 10, 210, 25));
       ...
       try{
            if(F18no.getText().length() ==0){
               JOptionPane.showMessageDialog(rootPane, "Invalid Order Exchange ID! Please Check again","SuperMarket Management" , JOptionPane.ERROR_MESSAGE);
                ...
                exchange.setStockExchange(F18no.getText().toString(),java.sql.Date.valueOf(date.getDate()), fromNo.getText().toString(), toNo.getText().toString(), Double.valueOf(subTotalBprice.getText()), Double.valueOf(subTotalSprice.getText()), Integer.valueOf(billNo.getText())); 
                ...
                if(i==1){
                        ...
                        for(int n=0; n< RowCount1; n++){
                            System.out.println(dtm.getValueAt(n, 0).toString());
                            System.out.println(dtm.getValueAt(n, 1).toString());
                            System.out.println(dtm.getValueAt(n, 2).toString());
                            System.out.println(dtm.getValueAt(n, 3).toString());
                            System.out.println(dtm.getValueAt(n, 4).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockExchangeOUT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StockExchangeOUT dialog = new StockExchangeOUT(new javax.swing.JFrame(), true);
