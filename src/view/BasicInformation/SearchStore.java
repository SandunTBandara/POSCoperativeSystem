 ...
 * @author Sanu
 */
public class SearchStore extends javax.swing.JDialog {

    /**
     * Creates new form SearchStore
     */
    public SearchStore(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadStores();
    }
    ...
    { ResultSet result = null;
       try{
        ManageStore Managestore1 = new ManageStore();
        result = Managestore1.viewstorelocationtable();
        ...
        while(result.next())
        {
          ...
          vec.add(result.getString("stcode"));
          vec.add(result.getString("location"));
    ...
    private void stores1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_stores1MouseClicked
       ...
       stid =  (DtM.getValueAt(selectedrowindex , 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchStore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SearchStore dialog = new SearchStore(new javax.swing.JFrame(), true);
