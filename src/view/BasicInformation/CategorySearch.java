...
public class CategorySearch extends javax.swing.JDialog {
    ...
    public CategorySearch(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadCategory();
    }
    ...
    private void initComponents() {
        ...
        department1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Category No", "Name", "Department No"
            }
        ));
    ...
    {
       try{
            ManageCategory cap = new ManageCategory();
            ResultSet result = cap.displaytableview();

            DefaultTableModel model = (DefaultTableModel) department1.getModel();

            while (result.next()) {
                Vector vec = new Vector();
                vec.add(result.getInt("cno"));
                vec.add(result.getString("category"));
                vec.add(result.getInt("dno"));
    ...
    private void txtdepartmentsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtdepartmentsearchKeyReleased
        try {
            ManageCategory dep = new ManageCategory();
            ResultSet result = dep.Viewcategorytable(txtdepartmentsearch.getText(),dpno);

            DefaultTableModel model = new DefaultTableModel(new Object[][]{}, new String[]{"Category No", "Name", "Department No"});
    ...
    private void department1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_department1MouseClicked
        ...
        dno = Integer.valueOf(DtM.getValueAt(selectedrowindex , 2).toString());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CategorySearch dialog = new CategorySearch(new javax.swing.JFrame(), true);
